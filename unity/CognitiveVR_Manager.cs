...
#region Events
        ...
        */
        ...
        public void Initialize(string participantName="", string participantId = "", List<KeyValuePair<string,object>> participantProperties = null)
        {
            ...
            //Util.logDebug("@@@@@@@@@@@@@11");
            //for(var i=0;i<100;i++){
            new CustomEvent("hhhhhhhhhh").SetProperty("ok", "hehe").Send();
            new CustomEvent("test dobj").SetDynamicObject("temp_dobj_id").SetProperty("ok1", "hehe1").Send();
            new CustomEvent("test sensor").AppendSensors("heartrate").SetProperty("ok2", "hehe2").Send();
            //}
            ...
            {
                //Util.logDebug("@@@@@@@@@@@@@");
                SetSessionName("test_session_name");
                Core.SetSessionProperty("my_property_KEY", "my_property_VALUE");
        ...
        private void SetSessionProperties()
        {
            ...
            //[TEST]
            Core.SetSessionProperty("c3d.device.hmd.type", "Vive Pro Eye");
            //[TEST]
...
#region Application Quit, Session End and OnDestroy
        ...
        {
            Util.logDebug("OnApplicationQuit");
            IsQuitting = true;
